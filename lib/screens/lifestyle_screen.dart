...
class _LifestyleScreenState extends State<LifestyleScreen>
  ...
  final Map<String, IconData> _opcionesAElegir = const {
    ...
    // Extras opcionales (puedes quitar/añadir sin romper nada)
    'Organizado': Icons.checklist_rounded,
    'Amante de mascotas': Icons.pets_rounded,
    'Cocinitas': Icons.restaurant_menu_rounded,
    'Fiestero ocasional': Icons.celebration_rounded,
  };
  ...
  /* ---------- lógica ---------- */
  void _toggleGustos(String label) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: AnimatedBuilder(
        animation: _bgCtrl,
        builder: (_, __) {
          // Degradado animado coherente con el onboarding
          final palettes = [
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 6),
                            Text(
                              'Selecciona 1 o más opciones que te definan.',
                              textAlign: TextAlign.center,
                              style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    final chip = Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: sel ? _LifestyleScreenState.colorPrincipal : Colors.grey.shade300,
          width: sel ? 2 : 1,
        ),
        boxShadow: [
          if (sel)
            BoxShadow(
              color: _LifestyleScreenState.colorPrincipal.withOpacity(.18),
              blurRadius: 18,
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                colors: sel
                    ? const [
                  _LifestyleScreenState.colorPrincipal,
                  _LifestyleScreenState.colorPrincipalDark
                ]
          ...
          AnimatedSwitcher(
            ...
            child: sel
                ...
                key: ValueKey('check'),
                size: 18,
                color: _LifestyleScreenState.colorPrincipal)
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color:
                    _LifestyleScreenState.colorPrincipal.withOpacity(.32),
                    blurRadius: 24,
...
class _SoftGlowPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final colors = [
      _LifestyleScreenState.colorPrincipal.withOpacity(.18),
      _LifestyleScreenState.colorPrincipalDark.withOpacity(.12),
      _LifestyleScreenState.colorPrincipal.withOpacity(.12),
    ];
