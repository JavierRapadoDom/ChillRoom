...
class _SportsScreenState extends State<SportsScreen>
  ...
  final Map<String, IconData> _opcionesAElegir = const {
    ...
    'Pádel': Icons.sports_tennis, // mismo icon, distinto label
    'Senderismo': Icons.landscape_rounded,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: AnimatedBuilder(
        animation: _bgCtrl,
        builder: (_, __) {
          // Degradado animado (coherente con onboarding)
          final palettes = [
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 6),
                            Text(
                              'Elige 1 o más deportes que practiques o te gusten.',
                              textAlign: TextAlign.center,
                              style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    final chip = Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: sel ? _SportsScreenState.colorPrincipal : Colors.grey.shade300,
          width: sel ? 2 : 1,
        ),
        boxShadow: [
          if (sel)
            BoxShadow(
              color: _SportsScreenState.colorPrincipal.withOpacity(.18),
              blurRadius: 18,
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                colors: sel
                    ? const [
                  _SportsScreenState.colorPrincipal,
                  _SportsScreenState.colorPrincipalDark
                ]
          ...
          AnimatedSwitcher(
            ...
            child: sel
                ...
                key: ValueKey('check'),
                size: 18,
                color: _SportsScreenState.colorPrincipal)
          ...
          SizedBox(
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: _SportsScreenState.colorPrincipal.withOpacity(.32),
                    blurRadius: 24,
...
class _SoftGlowPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final colors = [
      _SportsScreenState.colorPrincipal.withOpacity(.18),
      _SportsScreenState.colorPrincipalDark.withOpacity(.12),
      _SportsScreenState.colorPrincipal.withOpacity(.12),
    ];
